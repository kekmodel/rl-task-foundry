...
def build_query_tool(session: ComposerSession) -> "FunctionTool":
            ...
            "spec": {
                **spec_schema,
                "description": (
                    ...
                    "after the selected output fields. submission_diagnostics "
                    "summarizes structural blockers for final label evidence, "
                    "including selected output fields whose query metadata marks "
                    "them blocked/internal or handle-like. If it appears, do "
                    "not submit the result; fix the blocker and rerun query. "
                    "If ordering diagnostics "
    ...
    return FunctionTool(
        ...
        description=(
            ...
            "submission_diagnostics highlights final-label blockers such as "
            "blocked/internal selected outputs; blocking "
