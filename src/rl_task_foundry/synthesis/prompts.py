...
def build_synthesis_agent_instructions(
    ...
    return "\n\n".join([
        ...
        "duplicate projected answer rows appear, block even if source "
        "rows differ; add natural visible field/aggregate. If still duplicate "
        "or if only sequence/reference/record-order can distinguish them, "
        "switch label. Do not shrink limits or add hidden handles.\n"
