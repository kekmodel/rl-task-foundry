...
def build_synthesis_agent_instructions(
    ...
    return "\n\n".join([
        ...
        "- Source-sensitive fields (status, type, category, frequency, stage, "
        "route) need the same source role used by the query path. "
        "Broad entity wording is not enough if another reachable surface can "
