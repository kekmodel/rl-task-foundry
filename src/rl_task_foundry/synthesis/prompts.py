...
def build_synthesis_agent_instructions(
    ...
    return "\n\n".join([
        ...
        "diagnostics; no global answer with a decorative entity.",
        ...
        "- Keep request realistic/compact. Field keys stay in JSON, not "
        "request text; avoid schema-like aliases in parentheses. If controls "
        "need long tie-breaks or mechanical field lists, choose another label.\n"
        ...
        "user-visible non-handles. Handle refs only "
        "when query marks them user-visible and request asks; "
        ...
        "sibling joins that can pair unrelated child rows; one grounded "
        ...
        "equivalent for exact verification.\n"
        ...
        "there is no fixed ladder. Keep the same task, not a new task or difficulty "
        "jump.\n"
        ...
        "schedule, eligibility check, or plan-like list for arbitrary good "
        "DBs.\n"
